...
the goal of the project is to provide a working function_analyzer for all of the Algebra 2 
function types:  polynomial, radical, rational, exponential, logarithmic, piecewise.
